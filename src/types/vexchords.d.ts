declare module "vexchords" {
    export interface ChordBoxOptions {
        ...
        fontFamily?: Pick<CSSStyleDeclaration, 'fontFamily'>;
        fontSize?: Pick<CSSStyleDeclaration, 'fontSize'>;
        fontWeight?: Pick<CSSStyleDeclaration, 'fontWeight'>;
        fontStyle?: Pick<CSSStyleDeclaration, 'fontStyle'>;
        labelWeight?: Pick<CSSStyleDeclaration, 'fontWeight'>;
    }
    ...
    export class ChordBox
    {
        ...
        draw(options: VexChordDefinition): any;
    }

    export function draw(selector: string|Element, options: VexChordDefinition, chordBoxOptions?: ChordBoxOptions): any;
}
